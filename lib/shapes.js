// Selection of shapes the user can choose from
const shapeOptions = ["Circle", "Square", "Triangle"]

// Selection of matchable colors
const colorOptions = {
    "aliceblue":"#f0f8ff",
    "antiquewhite":"#faebd7",
    "aqua":"#00ffff",
...
// Function to validate the input of the color
function isValidColor(input) {
    return Object.values(colorOptions).includes(input) || Object.keys(colorOptions).includes(input);
  }

// Function of questions for the user
function gatherInfo(){
        return [
            {
                type: "list",
              ...
              },
              {
                ...
                validate: input => isValidColor(input) || 'Please enter a valid color name or hex value.'
              },
              {
                type: "input",
...
module.exports = { gatherInfo, Circle, Square, Triangle }